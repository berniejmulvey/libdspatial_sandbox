...
for (i in c(1:length(caps))){
  ...
  res_list[[i]] <- nnSVG(splc2.samp,assay_name = "logcounts",BPPARAM = sbp)
  rm(splc2.samp,cap)
  gc(full=T)
}
...
# saveRDS(res_list,"nnSVG_results_4of8samples_050423.RDS")
```


### Let's take a look at one nnSVG result object from our result list.
```{r}
View(res_list[[1]])
```
